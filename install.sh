...
# Cria publish.sh com as novas funcionalidades
cat > publish.sh << 'EOF'
#!/bin/bash
set -e
...
EOF
chmod +x publish.sh
echo "✅ Script publish.sh criado com correção automática de line breaks e suporte a domínio."

echo "🎉 Instalação concluída!"
echo "Use ./publish.sh para atualizar SUMMARY.md, corrigir line breaks, commitar alterações, e publicar o site."